...
class FGVCConfig:
    ...
    batch_size: int = 16  # Physical batch size (reduced for 16GB GPU with 448x448 images)
    gradient_accumulation_steps: int = 2  # Accumulate gradients over 4 steps to maintain effective batch size of 16
    num_epochs: int = 100
